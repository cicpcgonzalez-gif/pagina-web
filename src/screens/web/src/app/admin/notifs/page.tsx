export default function AdminNotifsPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 pb-16 pt-10 text-white bg-night-sky">
      ...
      <p className="mt-2 text-white/80">Templates de email/push y remitentes.</p>
      <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/80">
        Administra aquí plantillas, remitentes y disparadores. Acceso reservado a superadmin.
      </div>
    </main>
  );
}
