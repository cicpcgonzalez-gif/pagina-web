export default function AdminRolesPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 pb-16 pt-10 text-white bg-night-sky">
      ...
      <p className="mt-2 text-white/80">Asignar admin/superadmin y límites de acceso.</p>
      <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/80">
        Conecta aquí tu UI para cambiar roles y scopes de acceso. Acceso reservado a superadmin.
      </div>
    </main>
  );
}
