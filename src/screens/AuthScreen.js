        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={[styles.scroll, { justifyContent: 'center', minHeight: '100%' }]}>            
            ...
            <View style={{ marginTop: 40, alignItems: 'center', paddingBottom: 20 }}>
              <Text style={{ color: palette.muted, fontSize: 12, fontWeight: '700' }}>La suerte favorece a los que participan.</Text>
              <Text style={{ color: palette.muted, fontSize: 10, marginTop: 4, opacity: 0.8 }}>Versión Demo v1.0.0</Text>
              <Text style={{ color: palette.muted, fontSize: 10, marginTop: 4, opacity: 0.8 }}>© 2025 MegaRifas • Demo no comercial</Text>
            </View>
          </ScrollView>
