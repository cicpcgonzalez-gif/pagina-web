        ...
        <div className="text-center mb-8">
          <div className="inline-block mb-4">
            <Image
              ...
              style={{ filter: "drop-shadow(0 0 30px rgba(251, 146, 60, 0.6))" }}
            />
          </div>
          ...
          <form className="space-y-6" onSubmit={onSubmit}>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  style={{ background: "rgba(15, 23, 42, 0.6)", borderColor: "rgba(71, 85, 105, 0.5)" }}
                />
              </div>
              <div>
            ...
            {message ? (
              <div
                ...
                style={
                  variant === "ok"
                    ? { background: "rgba(34, 211, 238, 0.10)", borderColor: "rgba(34, 211, 238, 0.35)" }
