...
export default function AdminMovementsPage() {
  return (
    <RequireRole allow={["admin", "organizer", "superadmin"]} nextPath="/admin/movements" title="Movimientos">
        ...
        <header className="sticky top-0 z-20 bg-slate-950/90 backdrop-blur border-b border-slate-800">
          <div className="mx-auto max-w-4xl px-4 py-4">
            <div className="text-center">
              ...
              <h1 className="text-2xl font-extrabold text-white">MOVIMIENTOS</h1>
        ...
        <main className="mx-auto max-w-4xl px-4 py-4 space-y-6 pb-24">
          <section className="rounded-3xl border border-purple-500/30 bg-linear-to-br from-slate-900 to-slate-950 p-5 shadow-xl shadow-purple-900/30">
            <div className="inline-flex items-center gap-2 rounded-full bg-purple-800/60 px-3 py-1 text-sm font-semibold text-purple-100 shadow-inner shadow-purple-900/40">
              <Wallet2 className="h-4 w-4" /> Admin
            </div>
            <h2 className="mt-3 text-2xl font-extrabold leading-tight text-white">Movimientos</h2>
            <p className="mt-2 text-slate-200 text-sm">En la app muestra transacciones del admin. Lo conectamos cuando esté listo el endpoint.</p>
