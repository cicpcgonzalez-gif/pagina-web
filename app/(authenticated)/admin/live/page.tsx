...
export default function AdminLiveDrawPage() {
  return (
    <RequireRole allow={["admin", "organizer", "superadmin"]} nextPath="/admin/live" title="Sorteo en vivo">
      <div className="min-h-screen bg-linear-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
        <header className="sticky top-0 z-20 bg-slate-950/90 backdrop-blur border-b border-slate-800">
          <div className="mx-auto max-w-4xl px-4 py-4">
            <div className="text-center">
              ...
              <h1 className="text-2xl font-extrabold text-white">SORTEO EN VIVO</h1>
        ...
        <main className="mx-auto max-w-4xl px-4 py-4 space-y-6 pb-24">
          <section className="rounded-3xl border border-purple-500/30 bg-linear-to-br from-slate-900 to-slate-950 p-5 shadow-xl shadow-purple-900/30">
            ...
            <h2 className="mt-3 text-2xl font-extrabold leading-tight text-white">Transmisión</h2>
            <p className="mt-2 text-slate-200 text-sm">Pendiente de URL/endpoint para el sorteo en vivo (stream).</p>
