      ...
      <div className="min-h-screen bg-linear-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
        ...
        <main className="mx-auto max-w-4xl px-4 py-4 space-y-6 pb-24">
          <section className="rounded-3xl border border-purple-500/30 bg-linear-to-br from-slate-900 to-slate-950 p-5 shadow-xl shadow-purple-900/30">
            ...
            <p className="mt-2 text-slate-200 text-sm">Reutiliza la gestión de rifas del Admin (misma API).</p>
            <div className="mt-4 flex flex-wrap gap-3">
              <Link className="inline-flex items-center gap-2 rounded-full bg-amber-400 px-5 py-3 text-sm font-extrabold text-slate-900 hover:bg-amber-300 transition" href="/admin/raffles">
                Ir a /admin/raffles
              </Link>
